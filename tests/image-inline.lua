...
assert(m.is_scroll_render_key('core:window:12'))
assert(m.is_scroll_render_key('document:markdown:window:12'))
assert(not m.is_scroll_render_key('document:markdown:buffer:3'))
